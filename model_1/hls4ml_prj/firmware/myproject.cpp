...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<model_default_t, 100352>(w2, "w2.txt");
        ...
        nnet::load_weights_from_txt<model_default_t, 128>(w8, "w8.txt");
        nnet::load_weights_from_txt<model_default_t, 64>(b8, "b8.txt");
        nnet::load_weights_from_txt<model_default_t, 8192>(w10, "w10.txt");
        nnet::load_weights_from_txt<model_default_t, 128>(b10, "b10.txt");
        nnet::load_weights_from_txt<model_default_t, 100352>(w12, "w12.txt");
        nnet::load_weights_from_txt<model_default_t, 784>(b12, "b12.txt");
        loaded_weights = true;
    }
#endif
    ...
    nnet::dense<input_t, layer2_t, config2>(encoder_input, layer2_out, w2, b2); // dense
    ...
    nnet::relu<layer10_t, layer11_t, relu_config11>(layer10_out, layer11_out); // dense_3_relu
